    ...
    >
      {({ values, isSubmitting, errors, handleChange}) => (
        <Form>
          ...
          <InputIcon name="phone" placeholder="Phone" icon="fa-phone" type="text" onChange={handleChange} value={values.phone} />
          ...
          <button type="submit" className="bg-green-500 active:bg-blue-700 text-white py-2 w-full rounded-full text-sm my-3" disabled={isSubmitting}>
