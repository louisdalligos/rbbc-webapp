...
export default function Terms() {
  return (
    <>
      <Head>
        <title>
          Terms &amp; Conditions - RBBC Realty | Real state, Condominiums for
          sale, House for sale, RFO, Rent to own
        </title>
      </Head>
      <PageLayout>
        <section className="container mx-auto h-full">
          ...
          <p className="leading-loose mb-6 ml-5">
            By accessing the website at{' '}
            <a href="https://www.rbbcrealty.com">https://www.rbbcrealty.com</a>,
          ...
          <ol type="a" className="leading-loose mb-6 ml-10 list-disc">
            <li>
              ...
              materials (information or software) on RBBC Realty Inc.'s website
              ...
              <ol type="i" className="leading-loose mb-6 ml-10 list-decimal">
                ...
                <li>
                  ...
                  contained on RBBC Realty Inc.'s website;
                </li>
                <li>
            ...
            <li>
              ...
              these restrictions and may be terminated by RBBC Realty Inc. at
          ...
          <ol type="a" className="leading-loose mb-6 ml-10 list-disc">
            <li>
              The materials on RBBC Realty Inc.'s website are provided on an 'as
              is' basis. RBBC Realty Inc. makes no warranties, expressed or
            ...
            <li>
              Further, RBBC Realty Inc. does not warrant or make any
          ...
          <p className="leading-loose mb-6 ml-5">
            In no event shall RBBC Realty Inc. or its suppliers be liable for
            any damages (including, without limitation, damages for loss of data
            or profit, or due to business interruption) arising out of the use
            or inability to use the materials on RBBC Realty Inc.'s website,
            even if RBBC Realty Inc. or a RBBC Realty Inc. authorized
          ...
          <p className="leading-loose mb-6 ml-5">
            The materials appearing on RBBC Realty Inc.'s website could include
            technical, typographical, or photographic errors. RBBC Realty Inc.
            does not warrant that any of the materials on its website are
            accurate, complete or current. RBBC Realty Inc. may make changes to
            the materials contained on its website at any time without notice.
            However RBBC Realty Inc. does not make any commitment to update the
            materials.
          </p>

          <h3 className="text-lg font-semibold">6. Links</h3>
          <p className="leading-loose mb-6 ml-5">
            RBBC Realty Inc. has not reviewed all of the sites linked to its
            website and is not responsible for the contents of any such linked
            site. The inclusion of any link does not imply endorsement by RBBC
            Realty Inc. of the site. Use of any such linked website is at the
            user's own risk.
          </p>

          <h3 className="text-lg font-semibold">7. Modifications</h3>
          <p className="leading-loose mb-6 ml-5">
            RBBC Realty Inc. may revise these terms of service for its website
